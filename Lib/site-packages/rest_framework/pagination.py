...
class PageNumberPagination(BasePagination):
    ...
    http://api.example.org/templates/?page=4
    http://api.example.org/templates/?page=4&page_size=100
    """
...
class LimitOffsetPagination(BasePagination):
    ...
    http://api.example.org/templates/?limit=100
    http://api.example.org/templates/?offset=400&limit=100
    """
